...
public class Mouse extends AppCompatActivity {
    ...
    public class SynJSON extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... voids) {
            try {
                String strURL ="http://csclub.ssru.ac.th/s56122201013/adproject/php_get_mouse.php";
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Adapter Adapter = new Adapter(Mouse.this,
                        iconString,nameStrings,desString);
                listView.setAdapter(Adapter);
            }catch (Exception e){
                Log.d("Mouse","onPost ==>" + e.toString());
            }
        }
    }//onPostExecute
