...
public class Monitor extends AppCompatActivity {
    ...
    public class SynJSON extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... voids) {
            try {
                String strURL ="http://csclub.ssru.ac.th/s56122201013/adproject/php_get_monitor.php";
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Adapter Adapter = new Adapter(Monitor.this,
                        iconString,nameStrings,desString);
                listView.setAdapter(Adapter);
            }catch (Exception e){
                Log.d("Monitor","onPost ==>" + e.toString());
            }
        }
    }//onPostExecute
