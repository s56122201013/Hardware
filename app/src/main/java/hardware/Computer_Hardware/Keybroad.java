...
public class Keybroad extends AppCompatActivity {
    //Explicit
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.keybroad);
        //Bind widget
    ...
    public class SynJSON extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... voids) {
            try {
                String strURL ="http://csclub.ssru.ac.th/s56122201013/adproject/php_get_keybroad.php";
                ...
                Log.d("Keybroad","doIn ==>"+ e.toString());
                return null;
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Adapter Adapter = new Adapter(Keybroad.this,
                        iconString,nameStrings,desString);
                listView.setAdapter(Adapter);
            }catch (Exception e){
                Log.d("Keybroad","onPost ==>" + e.toString());
            }
        }
    }//onPostExecute
